...
4. Render construye el grafo de calles de Monterrey durante el build. Es normal que este primer deploy tarde más que un despliegue normal; el grafo no se descarga al iniciar una simulación.
